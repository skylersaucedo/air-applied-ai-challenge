...
import torch
from transformers import CLIPProcessor, CLIPModel, CLAPProcessor, CLAPModel, VideoMAEFeatureExtractor, VideoMAEForVideoClassification
import base64
import io
import logging
...
class QdrantHandler:
    ...
    def _initialize_models(self):
        ...
        self.video_model = VideoMAEForVideoClassification.from_pretrained("MCG-NJU/videomae-base")
        self.video_processor = VideoMAEFeatureExtractor.from_pretrained("MCG-NJU/videomae-base")
    ...
    async def vectorize_image(self, image_data: Union[str, bytes], description: Optional[str] = None) -> List[float]:
